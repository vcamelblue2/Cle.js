...
const appDemoStackblitz = async ()=>{
  ...
  let [ f_libs_cle_lib_cagedle_js, f_libs_cle_routing_lite_routing_js, f_libs_cle_layouts_layouts_js
    ...
    await axios.get('https://raw.githubusercontent.com/vcamelblue2/clean.js/release/@0.0.12/main/lib/caged-le.js'),
    await axios.get('https://raw.githubusercontent.com/vcamelblue2/clean.js/release/@0.0.12/main/routing/lite_routing.js'),
    await axios.get('https://raw.githubusercontent.com/vcamelblue2/clean.js/release/@0.0.12/main/layouts/layouts.js')
   ])
